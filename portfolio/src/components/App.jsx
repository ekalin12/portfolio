  ...
  return (
    ...
    <div className="blobContainer">
      ...
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="50%" y="30%" dominant-baseline="middle" text-anchor="middle" font-size="1em">Frontend</text>
        <text x="50%" y="40%" dominant-baseline="middle" text-anchor="middle" font-size=".5em">Javascript</text>
        <text x="50%" y="45%" dominant-baseline="middle" text-anchor="middle" font-size=".5em">React</text>
        <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size=".5em">Next.js</text>
      ...
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="50%" y="30%" dominant-baseline="middle" text-anchor="middle">Backend</text>
...
<div className="CMOverlay">
  ...
  <svg id="CMWave" version="1" baseProfile="full" width="100%" height="100%" viewBox="0 0 1920 969">
    ...
    747.148717948718 1920,669 C 1920,669 1920,969 1920,969 Z"
     stroke="none" stroke-width="0" fill={SVGColorOne} class="transition-all duration-300 ease-in-out delay-150"></path>
    ...
    1003 1920,969 1920,969 Z"
     stroke="none" stroke-width="0" fill={SVGColorTwo} class="transition-all duration-300 ease-in-out delay-150"></path>
    </svg>
